                          ...
                          <div class="card">
                            <div class="card-body">
                              <div class="d-sm-flex justify-content-between align-items-start">
                                  ...
                                  <div>
                                      <a href="{{ route('production.search')}}" class="btn btn-primary btn-lg text-white mb-0 me-0"><i class="mdi mdi-plus-circle-outline"></i>Nouvelle vente</a>
                                  </div>
                              </div>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card">
                          <div class="card">
                            <div class="card-body">
                              <div class="d-sm-flex justify-content-between align-items-start">
                                  <div>
                                      <h4 class="card-title">Liste de Ventes Mensuelles [{{ $month }}]</h4>
                                  </div>    
                                  <div id="performance-line-legend"></div>
                                  <div>
                                      <a href="{{ route('production.search')}}" class="btn btn-primary btn-lg text-white mb-0 me-0"><i class="mdi mdi-plus-circle-outline"></i>Nouvelle vente</a>
                                          ...
                                          <td>
                                              @if(Auth()->check())
                                                  ...
                                                  <div class="row">
                                                      {{--  edit  --}}
                                                      {{-- <div class="col-lg-6">
                                                          <a href="{{ route('sale.edit', ['sale' => $year->id]) }}" _method="GET" 
