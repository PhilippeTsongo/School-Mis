                                          ...
                                          <select id="exampleInputUsername4" name="sale" class="form-control" required>
                                            @foreach($sales as $sale)
                                              <option value="{{ $sale->id }}">
                                                Vente numéro  {{ $sale->sale_number }} de 
                                                @if($sale->production)
                                                  @if($sale->production->unit)
                                                    @if($sale->production->category)
                                                      {{ $sale->quantity . $sale->production->unit->name }}  de 
                                                      {{ $sale->production->category->name }} à {{ $sale->price .'$'}} </option>
                                                    @endif
                                                  @endif
                                                @endif
                                            @endforeach  
                                      ...
                                      <div class="col-lg 12">   
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                              ...
                                              <input type="number" name="montant" :value="old('montant')" required autofocus  class="form-control" id="exampleInputUsername2" placeholder="montant">
                                          </div>
                                        </div>
                                      </div>
                                    </div>
