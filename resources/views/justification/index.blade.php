                                ...
                                <div class="col-lg-12 grid-margin stretch-card">
                                    ...
                                    <div class="card-body">
                                        <div class="d-sm-flex justify-content-between align-items-start">
                                            ...
                                            <div>
                                                <a href="{{ route('justification.create')}}" class="btn btn-primary btn-lg text-white mb-0 me-0"><i class="mdi mdi-plus-circle-outline"></i>Nouvelle Pièce Justificative</a>
                                            </div>
                                        </div>
