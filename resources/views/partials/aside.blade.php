  ...
  @if(Auth()->user()->userType)
    <nav class="sidebar sidebar-offcanvas" id="sidebar">
      <ul class="nav">
        ...
        @endif
        @if(Auth()->user()->userType->name == 'Administrateur' OR Auth()->user()->userType->name == 'Entrepreneur' OR Auth()->user()->userType->name == 'Producteur')
        ...
        @if(Auth()->user()->userType->name == 'Administrateur' OR Auth()->user()->userType->name == 'Entrepreneur' OR Auth()->user()->userType->name == 'Financier')
        ...
        @if(Auth()->user()->userType->name == 'Administrateur' OR Auth()->user()->userType->name == 'Entrepreneur' OR Auth()->user()->userType->name == 'Comptable')
          <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="office-elements">
              <ul class="nav flex-column sub-menu">
                ...
                <li class="nav-item"><a class="nav-link" href="{{ route('logistique.index')}}">Liste de Logistiques</a></li>
              </ul>
            </div>
          </li>
        @endif
