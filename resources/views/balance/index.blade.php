                                                            ...
                                                            <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                                                <h2 class="me-2 fw-bold">
                                                                    <span class="text-info"> 
                                                                        ...
                                                                        @endforeach
                                                                        {{'Recettes: '. number_format($total_daily_recette, 02) }}$ 
                                                                    </span> |

                                                                        {{-- Total charges --}}
                                                                        <?php $total_daily_charge = 0; ?>
                                                                        @foreach($daily_charges as $daily_charge)
                                                                            <?php $total_day_charge = $total_day_charge + $daily_charge->montant; ?>
                                                                        @endforeach
                                                                   ...
                                                                   <span class="text-success">
                                                                       =  {{ 'Différence: '. number_format($total_daily_recette - $daily_charges, 02) }}$  
                                                                   </span>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-body text-info">
                                                                    <p class="card-text">{{ number_format($total_daily_recette, 02) .'$'}} </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                                                <h2 class="me-2 fw-bold">
                                                                    <span class="text-info"> 
                                                                        ...
                                                                        @endforeach
                                                                        {{'Recettes: '. number_format($total_month_recette, 02) }}$ 
                                                                    </span> |
                                                                    ...
                                                                    {{-- balance ou différence entre les recettes et les charges  --}}
                                                                    <span class="text-success">
                                                                        =  {{ 'Différence: '. number_format($total_month_recette - $month_charges, 02) }}$  
                                                                    </span>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-body text-info">
                                                                    <p class="card-text">{{ number_format($total_month_recette, 02) .'$'}} </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="d-sm-flex align-items-center mt-4 justify-content-between">
                                                                <h2 class="me-2 fw-bold">
                                                                    <span class="text-info"> 
                                                                        ...
                                                                        @endforeach
                                                                        {{'Recettes: '. number_format($total_year_recette, 02) }}$ 
                                                                    </span> |
                                                                    ...
                                                                    {{-- balance ou différence entre les recettes et les charges --}}
                                                                    <span class="text-success">
                                                                        =  {{ 'Différence: '. number_format($total_year_recette - $year_charges, 02) }}$  
                                                                    </span>
                                                                </h2>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <div class="media-body text-info">
                                                                    <p class="card-text">{{ number_format($total_year_recette, 02) .'$'}} </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
