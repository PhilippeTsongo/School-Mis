                    ...
                    <div class="d-sm-flex align-items-center justify-content-between border-bottom">
                        ...
                        <div>
                            <div class="btn-wrapper">
                                ...
                                <a href="{{ route('sale.create')}}" class="btn btn-primary text-white me-2"><i class="mdi mdi-plus-circle-outline"></i>Nouvelle Vente</a>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <table class="table table-striped">
                                                ...
                                                @forelse($productions as $production)    
                                                    <form action="{{ route('sale.store') }}" method="post" onSubmit="return confirm('Voulez-vous vendre cette production?');">
                                                        ...
                                                        <input type="hidden" name="sale_price" value="{{ $production->sale_price }}">
                                    ...
                                    <div class="col-md-6 col-lg-12 grid-margin">
                                        <div class="card bg-primary card-rounded">
                                            <div class="card-body pb-0">
                                                <h4 class="card-title card-title-dash text-white mb-4">Nombre total de ventes journalières</h4>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <p class="status-summary-ight-white mb-1">Total</p>
                                                        <h2 class="text-info">{{ $dailys->count()}}</h2>
                                                    </div>
                                                    <div class="col-sm-8">
