                                    ...
                                    <div class="row">
                                      <div class="col-lg 6">   
                                        <div class="form-group">
                                          ...
                                          <select id="exampleInputUsername5" name="matiere" class="form-control" required>
                                      ...
                                      <div class="col-lg 6">   
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="matiere_quantity" value="{{ old('matiere_quantity')  }}" required class="form-control" id="exampleInputEmail6" placeholder="Quantité de la matière">
                                        </div>
                                      </div>
                                    </div>
                                    <div class="row">
